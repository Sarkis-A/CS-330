...
public:
	...
	void RenderPacifier(float Xpos, float Ypos, float Zpos);
	void RenderBabyLotion(float Xpos, float Ypos, float Zpos);
	void RenderCup(float Xpos, float Ypos, float Zpos);
	void RenderJam(float Xpos, float Ypos, float Zpos);
	void RenderBottle(float Xpos, float Ypos, float Zpos);
};